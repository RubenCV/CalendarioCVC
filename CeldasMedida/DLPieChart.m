...
- (void)renderInLayer:(DLPieChart *)layerHostingView dataArray:(NSMutableArray*)dataArray
{
    ...
    */
    [self.DLColorsArray addObject:[UIColor colorWithRed:0.953 green:0.471 blue:0.443 alpha:1]];
    [self.DLColorsArray addObject:[UIColor colorWithRed:.8 green:.8 blue:0.263 alpha:1]];
    [self.DLColorsArray addObject:[UIColor colorWithRed:0.553 green:0.776 blue:.9 alpha:1]];
    [self.DLColorsArray addObject:[UIColor colorWithRed:0.553 green:0.776 blue:0.251 alpha:1]];
